...
export const Search = () => {
    ...
    return (
        ...
        {images.map((img) => (
        <div className="card" key={img.id}><span><img src={img.largeImageURL} alt='img' /><span className="photo"><span><strong>Photo: {img.user}</strong></span><span><strong className="modal-open"
        onClick={()=> {handleModal()
